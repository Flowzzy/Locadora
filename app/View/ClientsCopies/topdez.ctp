<div class="clientsCopies index">
	<h2><?php echo __('Clients Copies'); ?></h2>
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($clientsCopy['Client']['nome'], array('controller' => 'clients', 'action' => 'view', $clientsCopy['Client']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($clientsCopy['Reqstate']['designacao'], array('controller' => 'reqstates', 'action' => 'view', $clientsCopy['Reqstate']['id'])); ?>
		</td>
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $clientsCopy['ClientsCopy']['id'])); ?>
                        <?php echo $this->Html->link(__('Devolver'), array('action' => 'devfilme', $clientsCopy['ClientsCopy']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $clientsCopy['ClientsCopy']['id']), array(), __('Are you sure you want to delete # %s?', $clientsCopy['ClientsCopy']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Alugar Filme'), array('action' => 'add')); ?></li>
                <li><?php echo $this->Html->link(__('Devolver Filme'), array('action' => 'devofilme')); ?></li>
