...
<?php echo $this->Form->create('ClientsCopy'); ?>
	<fieldset>
		<legend><?php echo __('Edit Clients Copy'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ClientsCopy.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('ClientsCopy.id'))); ?></li>
