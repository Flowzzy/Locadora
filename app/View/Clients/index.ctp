<div class="clients index">
	...
	<tr>
		...
		<td><?php echo h($client['Client']['idade']); ?>&nbsp;</td>
		<td><?php echo h($client['Client']['sexo']); ?>&nbsp;</td>
		<td><?php echo h($client['Client']['bairro']); ?>&nbsp;</td>
		<td><?php echo h($client['Client']['distrito']); ?>&nbsp;</td>
		<td><?php echo h($client['Client']['nuit']); ?>&nbsp;</td>
		<td class="actions">
