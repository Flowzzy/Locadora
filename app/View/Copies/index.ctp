<div class="copies index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('Cstate_id'); ?></th>
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $copy['Copy']['id']), array(), __('Are you sure you want to delete # %s?', $copy['Copy']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
